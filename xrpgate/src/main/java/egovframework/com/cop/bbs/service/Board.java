...
public class Board implements Serializable {
	...
	public String getMoblphonNoHead() {
		if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") > 0){
			return moblphonNo.substring(0, moblphonNo.indexOf("-"));
		}else if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") == -1){
			return moblphonNo.substring(0, 3);
		}
		return "";
	}

	public String getMoblphonNoMiddle() {
		if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") > 0){
			return moblphonNo.substring(moblphonNo.indexOf("-")+1, moblphonNo.lastIndexOf("-"));
		}else if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") == -1){
			return moblphonNo.substring(3, 7);
		}
		return "";
	}

	public String getMoblphonNoTail() {
		if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") > 0){
			return moblphonNo.substring(moblphonNo.lastIndexOf("-")+1);
		}else if(moblphonNo != null && !"".equals(moblphonNo ) &&  moblphonNo.indexOf("-") == -1){
			return moblphonNo.substring(7);
		}
		return "";
	}
