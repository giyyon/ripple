...
public class BBSManageDAO extends EgovComAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectPhoneQnAList(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectPhoneQnAList", boardVO);
    }
    /**
    ...
    /**
     * 전화상담/QnA게시물 목록에 대한 전체 건수를 조회 한다.
     * 
     * @param boardVO
     * @return
     * @throws Exception
     */
    public int selectPhoneQnAListCnt(BoardVO boardVO) throws Exception {
	return (Integer)select("BBSManageDAO.selectPhoneQnAListCnt", boardVO);
    }
	...
	update("BBSManageDAO.updatePhoneQnAArticle", board);
    }
