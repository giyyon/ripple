...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see egovframework.com.cop.bbs.TradeManageService.service.EgovBBSManageService#deleteBoardArticle(egovframework.com.cop.bbs.brd.service.Board)
     */
	...
	/**
     * 전화상담/QnA게시물 목록을 조회 한다.
     *
     * @see egovframework.com.cop.bbs.TradeManageService.service.EgovBBSManageService#selectBoardArticles(egovframework.com.cop.bbs.brd.service.BoardVO)
     */
    public Map<String, Object> selectPhoneQnAList(BoardVO boardVO) throws Exception {
		List<BoardVO> list = bbsMngDAO.selectPhoneQnAList(boardVO);
	
		int cnt = bbsMngDAO.selectPhoneQnAListCnt(boardVO);
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see egovframework.com.cop.bbs.TradeManageService.service.EgovBBSManageService#updateBoardArticle(egovframework.com.cop.bbs.brd.service.Board)
     */
    ...
    /**
     * 전화상담/QnA 한 건의 답변을 등록한다.
     * 
     * @param Board
     * @throws Exception
     */
    public void updatePhoneQnAArticle(Board board) throws Exception {
	bbsMngDAO.updatePhoneQnAArticle(board);
    }
    
    /**
     * 방명록 내용을 삭제 한다.
     *
     * @see egovframework.com.cop.bbs.TradeManageService.service.EgovBBSManageService#deleteGuestList(egovframework.com.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see egovframework.com.cop.bbs.TradeManageService.service.EgovBBSManageService#selectGuestList(egovframework.com.cop.bbs.brd.service.BoardVO)
     */
