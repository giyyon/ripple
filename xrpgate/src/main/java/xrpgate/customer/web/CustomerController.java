...
//    		                                                      final MultipartHttpServletRequest multiRequest, 
     ...
     * @throws Exception
     */
    @RequestMapping("/goQnAView.do")
    public String goQnAView(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	...
	return ".basic_customer/qnaDetailView";
    }   
