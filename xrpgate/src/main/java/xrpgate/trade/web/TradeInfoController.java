...
public class TradeInfoController implements ApplicationContextAware, InitializingBean {
    ...
    public HashMap<String, Object> insertRippleTradeSell(
		...
		try {
			...
			if("S".equals(tradeDetailVO.getTradeType())){
				...
				message = "리플 구매 대행 신청이 등록되었습니다. 처리 결과는 마이페이지에서 확인 가능합니다.";
			}
...
//	master.setUniqId(user.getUniqId());
    ...
    public String callExcutePurchase() throws Exception {
