...
<%@ include file="../include/taglib.jsp" %>
 ...
 <div class="content">
        ...
        <div class="admin_title"><img src="/images/admin/admin_faq_title.png" /></div>
        <div class="write_btn">
						...
						<tr>
							...
							<td class="admin_btn">
	                            ...
	                            <li><a href="#" name="btnDelete" data-nttId="${result.nttId}" data-bbsId="${result.bbsId}">
	                            	<img src="/images/admin/admin_del_btn.png" /></a>
	                            </li>
	                        </td>
...
<script type="text/javaScript" language="javascript">
	$(function(){
		...
		$("[name=btnDelete]").click(function(e){
			...
			$("#subForm input[name=pageIndex]").val($(".selected").text()); 
		...
		$("[name=btnRegist]").click(function(e){
			...
			$("#subForm").attr({action:"${contextPath}/admin/FAQCallInsertPage.do", target:""});
			$("#subForm").submit();
			return;
			
			var url = "${contextPath}/admin/FAQCallInsertPage.do?";
		...
		$("[name=btnModify]").click(function(e){
			...
			$("#subForm").attr({action:"${contextPath}/admin/FAQModify.do", target:""});
			$("#subForm").submit();
			return;
			var url = "${contextPath}/admin/FAQModify.do?";
			var nttId = $(this).attr("data-nttId");
			var bbsId = $("[name=bbsId]").val();
			var param = {
					nttId : nttId
	...
	function linkPage(pageNo){
		...
		$("#subForm").attr({action:"${contextPath}/admin/FAQList.do", target:""});
		$("#subForm").submit();
	}
	
	function fn_deleteBBS(data){
		if(data.isSuccess){
			alert("삭제되었습니다.");
