...
<%@ include file="../include/taglib.jsp" %>
 ...
 <div class="content">
        ...
        <div class="admin_title"><img src="/images/admin/admin_lib_title.png" /></div>
        <div class="write_btn">
...
<script type="text/javaScript" language="javascript">
	$(function(){
		...
		$("[name=btnRegist]").click(function(e){
			...
			$("#subForm").attr({action:"${contextPath}/admin/referenceCallInsertPage.do", target:""});
			$("#subForm").submit();
			return;
		...
		$("[name=btnModify]").click(function(e){
			...
			$("#subForm").attr({action:"${contextPath}/admin/referenceModify.do", target:""});
			$("#subForm").submit();
			return;
	...
	function linkPage(pageNo){
		...
		$("#subForm").attr({action:"${contextPath}/admin/referenceList.do", target:""});
		$("#subForm").submit();
	}
