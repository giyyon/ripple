    ...
    <div class="pop_table">
    	<table cellpadding="0" cellspacing="0">
        	<tr>
                ...
                <td width="250px">
                	<input type="text" name="password"style="width:200px" value="${result.password}"/>
                </td>
            </tr>
            <tr>
  ...
  <script> 
 	...
 	$(document).ready(function(){
 		...
 		$('[name=btnCancel]').click(function(e) {
 			$('#frm').attr('action', '${contextPath}/admin/referenceList.do'); 
 		   $("#frm").submit();
 		});
 		$('[name=btnSave]').click(function(e) {
			$('#frm').attr('action', '${contextPath}/admin/insertReferenceArticle.do'); 
			$("#frm").submit(); 
 		});
