...
<div id="section"> 
		...
		<div class="srh_wrap tlr mtf14">
			<ul class="lst_m">
				<li class="wrt"><b><a href="/admin/rippleNewsCallInsertPage.do">글쓰기</a></b></li>
			</ul>
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<div class="bbs_lst handPnt" name="bbs_lst"  onclick="goDetail('${result.bbsId}', '${result.nttId}');">
				...
				<span class="num" >
					<a href="/admin/rippleNewsModify.do?bbsId=<c:out value='${boardVO.bbsId}'/>&nttId=<c:out value="${result.nttId}"/>"><img src="${contextPath}/img/ico_modify.png" alt="수정"></a>
...
<script type="text/javaScript" language="javascript">
	...
	function linkPage(pageNo){
		...
		$('#subForm').attr('action', '${contextPath}/admin/rippleNewsList.do'); 
		$("#subForm").submit();
	}
	...
	function goDetail(bbsId, nttId){
		...
		$("#subForm").attr({action:"${contextPath}/admin/rippleNewsInqire.do", target:""});
		$("#subForm").submit();		
	}
</script>
