...
<script type="text/javaScript" language="javascript">
	...
	function fn_deleteXrpTrade(data){
		if(data.isSuccess){
			alert("삭제되었습니다.");
			location.href = "${contextPath}/admin/mberXrpTradeList.do?tradeType=S";
		} else {
			alert("삭제되지 않았습니다.");
		}
	}
