...
<div class="content">
        ...
        <div class="admin_title"><img src="${contextPath}/images/admin/admin_buy_title.png" /></div>
        <p class="admin_enter_btn">
        	<a href="#" name="btnModify" data-tradeId="" data-tradeType="B">
...
<script type="text/javaScript" language="javascript">
	...
	function fn_deleteXrpTrade(data){
		if(data.isSuccess){
			alert("삭제되었습니다.");
			location.href = "${contextPath}/admin/xrpgateTradeList.do?tradeType=B";
		} else {
			alert("삭제되지 않았습니다.");
		}
	}
