...
<!--타이틀시작-->
<div id="header3"><img src="/img/title0014.jpg" width="400" height="35" />
<!-- </div> -->
<!--타이틀끝-->
...
<div id="section"> 
	...
	<div id="aside">
		<img src="/img/s8_0006.jpg" usemap="QnA_Map"  width="790" height="1041" border="0" />
		...
		<div id="section021"><input name="nttSj" id="nttSj" type="text"style="width:680px; height: 20px;" /></div>
...
<script type="text/javaScript" language="javascript">
	$(function(){
		...
		$("form").attr({action:"${contextPath}/customer/insertQnAArticle.do", target:""});
