...
<div class="con_title">
	  <li>
      	<img src="/images/sub/library_title.png" />
      </li>
  </div> 
...
<script type="text/javaScript" language="javascript">
	$(function(){
		...
		$("[name=btnSearch]").click(function(e){
			...
			$("#subForm").attr({action:"${contextPath}/customer/referenceList.do", target:""});
			$("#subForm").submit();
		});
	...
	function goDetail(bbsId, nttId){
		...
		$("#subForm").attr({action:"${contextPath}/customer/referenceListInqire.do", target:""});
		$("#subForm").submit();		
	}
</script>
