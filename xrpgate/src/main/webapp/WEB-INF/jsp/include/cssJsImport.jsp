...
<!-- 
<script src="${contextPath}/Scripts/movieclip-0.5.0.min.js" type="text/javascript"></script>
<script src="http://code.createjs.com/movieclip-0.5.0.min.js"></script>
<script src="${contextPath}/Scripts/swfobject_modified.js" type="text/javascript"></script>
...
<script src="<c:url value='/js/jquery.ulslide.js'/>"></script>
<script src="<c:url value='/js/jquery.number.js'/>"></script>
