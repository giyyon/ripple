...
<script src="/js/file/jquery.ui.widget.js"></script>
...
<script src="/js/file/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="/js/file/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="/js/file/jquery.fileupload-process.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="/js/file/jquery.fileupload-image.js"></script>
<!-- The File Upload validation plugin -->
<script src="/js/file/jquery.fileupload-validate.js"></script>
<!-- The File Upload user interface plugin -->
<script src="/js/file/jquery.fileupload-ui.js"></script>
...
//							name : unescape(item.orignlFileNm),
		...
		completed : function(e, data) {
			...
			//모달의 데이터를 갱신
			filesInfo = $(this).closest('.modalContainer').data('data');
			if (filesInfo == null) {
				filesInfo = [];
			}
...
//					uploadedFileId = data.Data[i].atchFileId;
			...
			$(this).closest('.modalContainer').data('data', filesInfo);
			//IE9에서는 첨부파일을 업로드 한 이후 script 차원엥서 upload-templet -> download-templete 으로 전환하는데 한글명이 깨지는 현상이 발생.
//			getFileList(fileIds);				
		}
	});
