	...
	<div class="footer-in">
        ...
        <div class="icon">
            ...
            <!-- KB에스크로 이체 인증마크 적용 시작 -->
                ...
                <input type="hidden" name="mHValue" value='756ecbbfd5d05f82a2c96b67e33920c6201512031124970'/>
                </form>
                <a href="#" onclick="javascript:onPopKBAuthMark();return false;">
                <img src="http://img1.kbstar.com/img/escrow/escrowcmark.gif" border="0"/>
                </a>
                <!-- KB에스크로 이체 인증마크 적용 종료 --></li>
        </div>
    </div>
</div>
<div class="cc">
	<div class="cc_in">Copyrightⓒ2015 By XRPGATE. All right reserved.</div>
</div>
