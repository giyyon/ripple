...
<!--타이틀시작-->
<div id="header3"><img src="/img/title0011.jpg" width="400" height="35" />
</div>
<!--타이틀끝-->
...
<div id="section"> 
	<form:form commandName="boardVO"  id="form">
		<div id="aside"><img src="/img/s8_0003.jpg" width="790" height="1023" border="0"  usemap="#Map_ripple" />
		...
		<div id="section015"><input readonly="readonly" name="ntcrNm" id="ntcrNm"  value="<c:out value="${boardVO.ntcrNm}"/>"  type="text"style="width: 130px; height: 20px;" /></div>
		  <div id="section020">
		    <input name="requestBuyMoney" id="requestBuyMoney"  type="text"style="width: 150px; height: 20px;" />
		  </div>
		</div>
		</form:form>
	<!--우측메뉴 시작-->
...
<script type="text/javaScript" language="javascript">
	$(function(){
		$("form").attr({action:"${contextPath}/trade/insertRippleTradeBuy.do", target:""});
